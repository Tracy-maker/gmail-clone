  ...
  return (
    <SendMailWrapper>
      ...
      <SendMailForm onSubmit={handleSubmit}>
        ...
        <InputField type="text" name="subject" placeholder="Subject" ref={register({ required: true })} />

        {<SendMailError>Subject is required</SendMailError>}

        <MessageInput type="text" name="message" placeholder="Message..." ref={register({ required: true })} />
